...
void AEndlessRunnerCharacter::BeginPlay()
{
	...
	OnActorBeginOverlap.AddDynamic(this, &AEndlessRunnerCharacter::OnOverlapBegin);
...
void AEndlessRunnerCharacter::SpawnInitialTile()
{
	if (InitialTile != NULL)
	{
...
void AEndlessRunnerCharacter::Tick(float DeltaTime)
{
	...
	if (GameMode != nullptr)
	{
		...
		if (!PlayerDead)
		{
			...
			GameMode->IncreaseScrollingSpeed(1);
...
void AEndlessRunnerCharacter::OnOverlapBegin(AActor* OverlappedActor, AActor* OtherActor)
{
